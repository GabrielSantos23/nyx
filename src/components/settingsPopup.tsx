...
const SettingsPopup = () => {
  ...
  const [useGeminiPro, setUseGeminiPro] = useState(() => {
    return localStorage.getItem("nyx_model_preference") === "pro";
  });
  ...
  useEffect(() => {
    ...
    localStorage.setItem("nyx_undetectable", String(isUndetectable));
  ...
  useEffect(() => {
    ...
    localStorage.setItem("nyx_model_preference", modelType);
    try {
      // @ts-ignore
    ...
    <div className="w-fit h-fit bg-transparent flex flex-col">
      ...
      >
        ...
        <div
          // @ts-ignore
          onClick={() =>
            window.electronAPI.openExternal("https://buymeacoffee.com")
          }
        ...
        >
          <div className="flex items-center gap-3">
            ...
            <span className="text-[12px] text-slate-400 group-hover:text-pink-100 transition-colors">
              Donate
            </span>
          </div>
