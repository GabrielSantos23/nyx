...
import evinProfile from "./icon.png";
...
export const AboutSection: React.FC<AboutSectionProps> = () => {
  ...
  return (
    <div className="space-y-6 animated fadeIn pb-10">
      <div>
        <h3 className="text-lg font-bold text-text-primary mb-1">About Nyx</h3>
          ...
          <div className="p-5 bg-bg-card/50">
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-xs text-text-secondary leading-relaxed">
                  A local vector memory system allows Nyx to recall details from
                  your past interactions. Context retrieval happens securely
                  on-device where possible to minimize latency.
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="bg-bg-item-surface rounded-xl border border-border-subtle p-5 space-y-4">
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-text-secondary mt-1 leading-relaxed">
                ...
                (Google Cloud, Groq) and are not stored permanently by Nyx's
                servers.
              </p>
            </div>
          </div>
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-text-secondary mt-1 leading-relaxed">
                Nyx listens only when active. It does not record video, take
        ...
        <div className="space-y-4">
              ...
              <div className="flex items-start gap-4">
                ...
                <div className="pt-0.5">
                  <div className="flex items-center gap-2 mb-1">
                    ...
                    <span className="text-[10px] font-medium px-1.5 py-[1px] rounded-full bg-yellow-400/10 text-yellow-200 border border-yellow-400/5">
                      Creator
                    </span>
                  </div>
                  <p className="text-xs text-text-secondary leading-relaxed max-w-lg">
                    ...
                    <br />
                    <span className="font-bold text-text-primary">Nyx</span> is
                    made to feel fast, quiet, and respectful of your privacy.
                  </p>
                </div>
              </div>
              <div className="flex items-center gap-4 pl-[60px]">
                <a
                  href="https://github.com/GabrielSantos23/nyx.git"
                  onClick={(e) =>
                    handleOpenLink(
                      e,
                      "https://github.com/GabrielSantos23/nyx.git",
                    )
                  }
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <a
              href="https://github.com/GabrielSantos23/nyx.git"
              onClick={(e) =>
                handleOpenLink(e, "https://github.com/GabrielSantos23/nyx.git")
              }
            ...
            >
              ...
              <div>
                ...
                <p className="text-xs text-text-secondary mt-0.5">
                  Love Nyx? Support us by starring the repo.
                </p>
              </div>
            </a>

            <a
              href="https://github.com/GabrielSantos23/nyx/issues"
              onClick={(e) =>
                handleOpenLink(
                  e,
                  "https://github.com/GabrielSantos23/nyx/issues",
                )
              }
              className="bg-bg-item-surface border border-border-subtle rounded-xl p-5 transition-all group flex items-center gap-4 cursor-pointer h-full hover:bg-white/10"
            >
          ...
          <div className="bg-bg-item-surface rounded-xl border border-border-subtle p-5 flex flex-col md:flex-row items-center justify-between gap-4">
            ...
            <a
              ...
              onClick={(e) =>
                handleOpenLink(e, "mailto:evinjohnignatious@gmail.com")
              }
          ...
          <div className="bg-bg-item-surface rounded-xl border border-border-subtle p-5 flex flex-col md:flex-row items-center justify-between gap-4">
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-xs text-text-secondary mt-0.5">
                  Nyx is independent open-source software.
                </p>
              </div>
            </div>
            <a
              href="https://buymeacoffee.com/"
              onClick={(e) => handleOpenLink(e, "https://buymeacoffee.com")}
